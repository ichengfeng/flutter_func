...
import 'package:flutter_func/network/api/codable.dart';
...
class EntryResponserSerializer extends ResponseSerializer {
  @override
  ResponseModel<T> serialize<T>(Response response,
      NetworkJSONModelBuilder<T>? builder, String? searchKeyPath) {
    final res = ResponseModel<T>.empty();
    ...
    if (builder != null) {
      final resData = response.data;
      parseJson(resData, res, builder, "entry", searchKeyPath);
    }
