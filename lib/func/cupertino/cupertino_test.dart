...
class CupertinoWidgetTest extends StatelessWidget {
  static const String routeName = "/cupertino_test";

  const CupertinoWidgetTest({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      navigationBar: const CupertinoNavigationBar(
        middle: Text('Cupertino测试啊'),
      ),
      child: Container(
        padding: const EdgeInsets.all(12),
        child: Center(
          child: CupertinoButton(
            child: const Text('点我呀'),
            onPressed: (){
              showCupertinoDialog(
                ...
                builder: (ctx){
                  return CupertinoAlertDialog(
                    ...
                    content: const Text("话费余额不足，请及时充值！"),
                    actions: [
...
//
//   static final Map<String, List<String>> _dataSource = {
...
//                       if (cellIndex == 0) {
//                         return Header(title, color: Colors.white,);
//                       } else {
...
//   final double offset;
//
//   Header(this.title, {required this.color, this.offset = 0});
//
//   @override
//   Widget build(BuildContext context) {
//     return Container(
