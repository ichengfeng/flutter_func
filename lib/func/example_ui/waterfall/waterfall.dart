...
import 'package:flutter_func/func/example_ui/waterfall/sample/waterfall_sample.dart';
import 'package:flutter_func/widgets/colors/material_colors.dart';
import 'package:itools/screen_size.dart';

import 'sample/constant.dart';

class WaterfallPage extends StatelessWidget {
  static const String routeName = "/waterfall_test";
