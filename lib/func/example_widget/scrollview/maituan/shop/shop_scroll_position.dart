...
class ShopScrollPosition extends ScrollPosition
  ...
  late  ScrollDragController? _currentDrag = ScrollDragController(
    details: DragStartDetails(), delegate: this,
  );
  ...
  double setPixels(double newPixels) {
    assert(activity?.isScrolling == true);
  ...
  void absorb(ScrollPosition other) {
    ...
    typedOther._currentDrag?.dispose();
  }
